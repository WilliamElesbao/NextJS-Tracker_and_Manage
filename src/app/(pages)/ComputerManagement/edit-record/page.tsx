  ...
  useEffect(() => {
    const recordForEdit = async () => {
      ...
      if (response.ok) {
        ...
        setBroughtBy_user(data.broughtBy_user_FK);
        setHandedoverDate(data.handedoverDate);
        setGivenbackDate(data.givenbackDate);
      }
    };
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(`Erro ao editar os dados ${x.error.meta.target}`);
      }
    } catch (error) {
              ...
              >
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    ...
                    <DatePickerDemo
                      onDateChange={handleDateChange_2}
