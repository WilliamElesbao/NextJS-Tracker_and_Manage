        ...
        <div>
          ...
          <div className="mt-2">
            <input
              ...
              className="block w-full rounded-md border-0 p-1.5 bg-white text-black shadow-sm ring-1 ring-inset ring-ring placeholder:text-gray-100 focus:ring-2 focus:ring-inset focus:ring-ring sm:text-sm sm:leading-6"
            />
            {errors.username && (
