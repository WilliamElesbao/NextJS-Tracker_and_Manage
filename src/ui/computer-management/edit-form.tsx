  ...
  useEffect(() => {
    if (recordById) {
      form.reset({
        ...
        computerType:
          (recordById?.computerType as "NTB" | "DSK" | "WKS") ?? null,
        location: (recordById?.location as "Matriz" | "SP" | "BH") ?? null,
        computerStatus:
          (recordById?.computerStatus as
            | "available"
            | "underMaintenance"
            | "obsolete") ?? null,
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Select
                        ...
                        defaultValue={String(recordById.broughtBy_user_FK)}
                      >
